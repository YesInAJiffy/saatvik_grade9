...
| ----------------------------- | ------------------------ | --------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------- |
| **Respect & Communication**   | Speak respectfully       | No yelling, name-calling, or swearing; listen when others speak                                                 | Loss of privileges (e.g., gaming), **written apology**, extra chore |
|                               | Keep parents informed    | Respond to texts/calls                              | Earlier curfew for a week; outing restrictions          |
| **School & Responsibilities** | School comes first       | Homework completed on the day home work is given; any exceptions should be noted in a copy.                                           | Screen time paused until work is done                   |
|                               | Maintain effort & grades | Maintain A Grades; ask for help when needed                                                          | Temporary limit on social activities; tutoring time     |
|                               | Contribute to chores     | Daily: eat properly; put dishes back; throw your garbage in trash                                                       | Extra chore; reduced screen time                        |
...
| **Screen Time (Detailed)**    | Daily limits             | **Weekdays:** max **1 hours** phone after homework and 30 minutes TV; **Weekends:** max **3–4 hours** recreation (customize) | Device locks; time reduced next day                     |
